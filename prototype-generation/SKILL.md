...
- 角色管理: role list/search, create/edit dialog, menu permission tree, button permissions, data-scope settings, multiple-role summary where applicable, enable/disable, and save feedback.
...
- 网站配置: system name, logo, login-page display, copyright, base parameters, upload limits, message settings, dictionary/basic parameter entries, tenant/display configuration where applicable, save preview, and change feedback.
...
- 流程管理: process group, process definition list, basic information, dynamic form or business-form binding, workflow designer entry, approver/CC/rule configuration, enable/disable, publish/version status, and edit/design dialogs.
